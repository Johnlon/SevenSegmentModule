...
void display(int v, int dig) {
    ...
    if (a) {do { LATAbits.LATA5 = 1; } while(0);} else {TRISAbits.TRISA5();}
    if (b) {do { LATAbits.LATA4 = 1; } while(0);} else {TRISAbits.TRISA4();}
    if (c) {do { LATCbits.LATC5 = 1; } while(0);} else {TRISCbits.TRISC5();}
    if (d) {do { LATCbits.LATC4 = 1; } while(0);} else {TRISCbits.TRISC4();}
    if (e) {do { LATCbits.LATC3 = 1; } while(0);} else {TRISCbits.TRISC3();}
    if (f) {do { LATCbits.LATC6 = 1; } while(0);} else {TRISCbits.TRISC6();}
    if (g) {do { LATCbits.LATC7 = 1; } while(0);} else {TRISCbits.TRISC7();}
