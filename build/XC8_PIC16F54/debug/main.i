...
void display(int v, int dig) {
    ...
    if (a) {do { LATAbits.LATA5 = 1; } while(0);} else {do { LATAbits.LATA5 = 0; } while(0);}
    if (b) {do { LATAbits.LATA4 = 1; } while(0);} else {do { LATAbits.LATA4 = 0; } while(0);}
    if (c) {do { LATCbits.LATC5 = 1; } while(0);} else {do { LATCbits.LATC5 = 0; } while(0);}
    if (d) {do { LATCbits.LATC4 = 1; } while(0);} else {do { LATCbits.LATC4 = 0; } while(0);}
    if (e) {do { LATCbits.LATC3 = 1; } while(0);} else {do { LATCbits.LATC3 = 0; } while(0);}
    if (f) {do { LATCbits.LATC6 = 1; } while(0);} else {do { LATCbits.LATC6 = 0; } while(0);}
    if (g) {do { LATCbits.LATC7 = 1; } while(0);} else {do { LATCbits.LATC7 = 0; } while(0);}
...
# 141 "main.c"
    while (1) {
        ...
        int loByte = PORTAbits.RA0 +
                (PORTAbits.RA1 << 1) +
                (PORTAbits.RA2 << 2) +
                (PORTCbits.RC0 << 3);
        display(loByte, 0);
        _delay((unsigned long)((100000)*(7750/4000.0)));

        int hiByte = PORTCbits.RC1 +
                (PORTCbits.RC2 << 1) +
                (PORTBbits.RB4 << 2) +
                (PORTBbits.RB5 << 3);
        display(hiByte, 1);
